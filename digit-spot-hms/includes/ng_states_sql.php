...
//prepare location database

$chk_state_tbl = mysqli_query($mysqli,"SELECT * FROM states");
if(@ mysqli_num_rows($chk_state_tbl) == false)
{
	mysqli_query($mysqli, "CREATE TABLE states(id int, name varchar(255))");
	mysqli_query($mysqli, "CREATE TABLE local_governments(id int AUTO_INCREMENT, state_id int, name varchar(255), PRIMARY KEY (id))");
