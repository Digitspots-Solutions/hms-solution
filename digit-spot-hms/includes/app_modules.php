<?php
	...
	$_SESSION['app_service'] = (isset($_GET['aps']) && !empty($_GET['aps'])) ? $_GET['aps'] : $_SESSION['app_service'];
	...
	$moduleMenu .= '<span class="ln-display-box float-left cs-width-30 cs-height-30 rounded-element blue-white-state top-pull-7 alignct right-push-10 motion"><a href="" class="white-font" title="Return to Dashboard'.$_SESSION['app_service'].'"><b class="mbri-home"></b></a></span>';
