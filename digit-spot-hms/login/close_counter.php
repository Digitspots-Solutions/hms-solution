	...
	<body class="grey-1-theme y-scroll">
		...
		<div class="pads30" align="center">
			...
			<div class="fx-width-50 pads30">
				...
				<p class="top-pull-30">
					<input type="button" value="Return" class="submit pads10 dark-black-white-state rounded-button nc-width-30" onclick="window.location.href='<?php echo $_get_portal.PUB_FLD.'admin/portal'.PHP_EXT.'?aps='.$_SESSION['app_service']; ?>'">
				</p>
			</div>
		</div>
	</body>
