...
<div class="block-element bottom-push-30">
 	<span class="ln-display-box float-left">
		...
		&nbsp; Note: here you can manage all frontdesk packages. Remove non-applicable rooms, update price etc.
 	</span>
 	<span class="ln-display-box float-right">
		<h4 class="large">Frontdesk Packages &nbsp; +</h4>
	</span>
				...
				<div class="nc-width-90">
					<form action="" method="post" onsubmit="objDisplay('processbar')" autocomplete="off">
						<div class="bottom-push-20 alignlt">
							...
							<input type="hidden" name="packagetype-mdl" id="packagetype-mdl" value="<?php echo $fieldset; ?>">
						</div>
						...
						<span class="block-element bottom-push-10">
							<div class="ln-display-box float-left nc-width-45">
								<span class="ln-display-box float-left nc-width-90 right-push-10">
									...
									<input type="text" name="fieldset5" id="fieldset5" placeholder="Enter number of night" value="<?php echo $drawratetable; ?>" required="required" pattern="\d*" readonly>
								</span>
...
#-----------------------------------------------------------------------------------------------------------------
	...
	$constrain = array("deletedata"=>0,"packagetype"=>1);
	$row = "array";
