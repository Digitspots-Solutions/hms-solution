...
<script>
	...
	function addFund() {
		...
		vhtml += '</div>';
		vhtml += '<div class="top-pull-10 motion">';
		vhtml += '<input type="submit" name="addbutton" id="addbutton" value="Add" class="nc-width-100 dark-black-white-state top-pull-15 bottom-pull-15 nunito-semibold rounded-button anchor ft-mini-size letter-spacing-2">';
		vhtml += '<p class="top-pull-15 alignct"><a href="javascript://" class="black-font" title="Close" onclick="cancelPrSign()">Cancel x</a></p>';
		vhtml += '</div>';
		vhtml += '</form>';
