		...
		//if(isset($isupdated) && $isupdated == 2) {
			...
			if(isset($th_biller) && $th_biller > 0) {
				...
				if($wgt_bill_type == "Corporate") {
					...
					$transaction_desc = "Migrated booking bills for booking number: ".$wgt_booking_number;
			...
			if($bkgtypeBf == 'corporate' && $bkgbillBf == 'Corporate' && $bkgRsBf == 'Checking In') {
				...
				$transaction_desc = "Reversed debit booking bills for booking number: ".$wgt_booking_number;
