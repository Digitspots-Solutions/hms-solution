...
<div class="block-element bottom-push-5">
 	<span class="ln-display-box float-left">
		...
		&nbsp; Note: here you can get the list of check-out guest reports
 	</span>
...
<div class="block-element bottom-push-30 light-yellow-theme pads10">
	<h3 class="large">CheckOut Report</h3>
	<form action="" method="post">
		...
		<span class="ln-display-box float-left nc-width-25 right-pull-5 alignct">
	...
	if(isset($_POST['submitbutton']))
	{
		...
		?>
			...
			<div id="section-to-print" class="block-element">
				...
				<small class="block-element alignct">CheckOut Report Between <?php echo $checkin_date_from.' And '.$checkout_date_to; ?></small>
				...
				<?php
					...
					if(isset($_POST['fieldset3']) && $_POST['fieldset3'] > 0) { $shift_checkin_query = array("checkin"=>1,"checkout"=>1,"booking_type"=>$_POST['fieldset3'],"deletedata"=>0); $t_bkt = $_POST['fieldset3']; } else { $shift_checkin_query = array("checkin"=>1,"checkout"=>1,"deletedata"=>0); $t_bkt = 0; }

					$additionalQuery = " AND datelogged BETWEEN '".$_POST['fieldset1']."' AND '".$_POST['fieldset2']."'"; $shift_checkin_dataproperty = "booking_number,roomid,customerid,userid,startdate,endate,datelogged";
					...
					?>
						<div class="block-element top-push-20">
							<h4 class="large"><?php echo $ushift_data[1]; ?></h4>
							<div class="block-element top-push-5 box-border-thick">
								<table cellpadding="0" cellspacing="0" class="ft-xxsml-size">
									<tr>
										...
										<th width="120px" align="center">Checkout Date</th>
										<th width="100px" align="center">Checkout By</th>
									</tr>
									...
									<?php
										...
										if(is_array($get_shift_checkin_data)) {
											...
											foreach ($get_shift_checkin_data as $scd_key => $scd_value) {
												...
												$get_checker_data = mysqli_data_fetch($tbL127,'status,checkout_date,checkout_time',$checker,'noarray');
