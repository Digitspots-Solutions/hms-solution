					...
					if($_POST['fieldset4'] == 0) {
						...
						if(is_array($ushift_data)) {
							...
							foreach ($ushift_data as $ushf_key => $ushf_value) {
								...
								if(isset($_POST['fieldset3']) && $_POST['fieldset3'] > 0) { $shift_checkin_query = array("checkin"=>1,"booking_type"=>$_POST['fieldset3'],"deletedata"=>0); $t_bkt = $_POST['fieldset3']; } else { $shift_checkin_query = array("checkin"=>1,"deletedata"=>0); $t_bkt = 0; }
