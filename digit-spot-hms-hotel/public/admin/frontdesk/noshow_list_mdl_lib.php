...
<div class="block-element bottom-push-30">
 	<span class="ln-display-box float-left">
		...
		&nbsp; Note: here you can get the list of no-show guests
 	</span>
		...
		<div class="cs-width-1200">
			<div id="section-to-print">
				<?php
					...
					$queryset = "deletedata=0 AND status='No Show'".$keywords." ORDER BY id DESC";
					...
					$keys = array(
						...
						"roomid"=>"room no.",
						"datelogged"=>"(df)date created",
						"checkin_byuser"=>"booked by"
					);
