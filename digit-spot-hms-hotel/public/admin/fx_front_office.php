...
$row = "array";
$constrain = array("moduleid"=>3,"status"=>"Active");
...
if(isset($myaccess) && $myaccess == 'super admin') {
	...
	if(is_array($dataCollect))
	{
		...
		<div class="block-element cs-height-100 sky-blue-theme top-pull-15 right-pull-10 left-pull-10">
			<small class="block-element"><b>Business Status</b> [<a href="javascript:startNightAudit()" class="royal-blue-font default-text-font-bold">Night Audit</a>]</small>
	...
	?>
		<input type="hidden" id="fo-mode" value="1">
	<?php
}
else
{
	$isprivilege = perform_role_check($tbL5,$myrole,3,0);
	if(isset($isprivilege) && $isprivilege >= 1) {
		...
		if(is_array($dataCollect))
		{
			...
			<div class="block-element cs-height-150 sky-blue-theme top-pull-15 right-pull-10 left-pull-10">
				<small class="block-element"><b>Business Status</b><?php if(isset($allowNightAudit) && $allowNightAudit == 200) { ?> [<a href="javascript:startNightAudit()" class="royal-blue-font default-text-font-bold">Night Audit</a>]<?php } ?></small>
				<div class="block-element top-pull-5 bottom-pull-15 bottom-push-5 ft-xsml-size">
					<small class="block-element bottom-push-3">Audit Done till: <b><?php echo $print_last_audit_date; ?></b></small><small class="block-element bottom-push-3">Business Date: <b><?php echo $print_business_date; ?></b></small>
