...
<div class="block-element bottom-push-30">
 	<span class="ln-display-box float-left">
		...
		&nbsp; Note: here you can see the list of <u>secret security service</u> (SSS) report
 	</span>
	...
	<div class="x-scroll">
		<div id="section-to-print" class="nc-width-100">
			...
			<div class="bottom-push-15" align="center">
				...
				<h3 class="large nobold default-text-font-bold">SSS Report (between <?php echo $startdate; ?> and <?php echo $endate; ?>)</h3>
			</div>

			<?php

				$queryset = "t1.deletedata=0".$keywords." ORDER BY t1.id DESC";
				$dataset = "SELECT t1.salutation,t1.fname,t1.lname,t1.mobile,t1.address,t1.city,t1.country,t1.occupation,t1.passport_no,t1.issue_date,t1.expiry_date,t1.issue_place,t2.checkin_date,t2.checkout_date,t2.roomid FROM {$tbL102} t1, {$tbL127} t2 WHERE t1.id=t2.customerid AND t2.status IN('CheckedIn') AND ".$queryset;
