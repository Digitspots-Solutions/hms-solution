<?php $smdl = "administration"; $logs = escape_data($_GET['logs']);  $for_mdl = 6; ?>

<div class="block-element bottom-push-30">
 	<span class="ln-display-box float-left">
		<a href="?logs=<?php echo $logs; ?>" title="Refresh"><img src="<?php echo DOMAIN_URL; ?>theme/images/general/refresh.png"></a>
		&nbsp; <b>Purchase Order Approval Configuration</b>
 	</span>
...
<?php
	...
	if(isset($_POST['submitbutton']))
	{
		...
		$constrain = "";
		$dataproperty = array("approval_setting"=>$for_mdl,"workflow_name"=>ucwords(strtolower($defaultname)),"isdefault"=>$isdefault);
		$isdata = mysqli_data_insert($tbL142,$dataproperty,$constrain);
