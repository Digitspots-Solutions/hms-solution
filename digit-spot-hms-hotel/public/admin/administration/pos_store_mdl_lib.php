...
<?php
	...
	if(isset($_POST['submitbutton']))
	{
		...
		$insert_dataproperty = array("store"=>$storage,"posname"=>ucwords(strtolower($fieldset1)),"postype"=>ucwords(strtolower($fieldset2)),"departmentid"=>$fieldset3,"isfoodtype"=>$fieldset4,"iscounter"=>$fieldset5,"isdiscount"=>$fieldset6,"guest_discount"=>$guest_discount,"staff_discount"=>$staff_discount);
	...
	if(isset($_POST['editbutton']))
	{
		...
		$insert_dataproperty = array("store"=>$storage,"posname"=>ucwords(strtolower($fieldset1)),"postype"=>ucwords(strtolower($fieldset2)),"departmentid"=>$fieldset3,"isfoodtype"=>$fieldset4,"iscounter"=>$fieldset5,"isdiscount"=>$fieldset7,"guest_discount"=>$guest_discount,"staff_discount"=>$staff_discount,"isfoodflash"=>$fieldset8);
	...
	$dataproperty = "id,store,posname,postype,departmentid,isfoodtype,iscounter,isfoodflash,isdiscount,guest_discount,staff_discount,status";
