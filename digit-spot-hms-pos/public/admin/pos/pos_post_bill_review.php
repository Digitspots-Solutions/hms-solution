		...
		?>
			<div class="block-element top-pull-10">
				...
				<p class="top-pull-10 bottom-pull-10 right-pull-30 alignrt">
					...
					<?php
						if($get_invoice_data[27] == 0) { if($reverseday <= $gh_get_allow_past_reverse && (isset($allowPosReverse) && $allowPosReverse == 200)) { ?><a href="javascript://" class="blue-font left-push-5" title="Reverse Order" onclick="doReverse('?logs=modals&prefix=pos&param=<?php echo $param; ?>&ftoken=<?php echo $booking_number; ?>&stoken=<?php echo $ths_token; ?>&reverse=<?php echo $order_number; ?>')"><b class="fa-share nobold right-push-5"></b> Cancel & Reverse</a><?php } } else { ?><b class="light-red-font nobold default-text-font-bold">Cancelled</b><?php }
					?>
				</p>
