...
include "../module_operation_privilege.php";
	...
	if(isset($_GET['order']) && isset($_GET['receipt']))
	{
		...
		$invoice_data_property = "order_number,invoice_number,posid,customerid,discount_amount,sub_total,tax_amount,bill_amount,foodtype,billtype,tableid,cover,detail,status,datelogged,timelogged,payment,id,biller,roomid,receipt_number,media,cheque_number,paydetail,paydate,paytime,isprinted,isreversed,cashier";
		...
		?>
			...
			<div class="block-element top-pull-10">
				...
				<p class="top-pull-10 bottom-pull-10 right-pull-30 alignrt">
					<?php if($get_invoice_data[26] == 0) { ?><a href="javascript:void(0)" class="blue-font ft-sml-size" onclick="window.print()"><b class="fa-print nobold dark-black-font"></b>&nbsp; Print A4</a><?php } ?>
				</p>
