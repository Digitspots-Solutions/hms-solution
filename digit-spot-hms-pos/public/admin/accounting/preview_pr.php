<?php
	...
	$supplierid = idget_fdata($tbL121,'order_number',$order_number,'supplierid');
	$supplier_name = idget_data($tbL114,$supplierid,'supplier_name');
	...
	$pr_iou_type = idget_fdata($tbL153,'pr_no',$order_number,'pr_type');
	$store_name = idget_data($tbL123,$wgt_po[0]['store'],'store_name');
...
<div id="section-to-print" class="block-element">
	...
	<?php if($pr_iou_type == 'Job Order'): ?>
		<h2 class="large nobold default-text-font-bold">JOB ORDER - <?php echo strtoupper($supplier_name); ?></h2>
	<?php else: ?>
	...
	<div class="top-push-30 bottom-push-30">
		<table cellspacing="5" cellpadding="5">
			...
			<tr>
				<td class="right-pull-10 left-pull-10"><?php echo $store_name; ?></td>
	...
	<table cellspacing="5" cellpadding="5">
		<tr>
			...
			<td class="default-text-font-bold right-pull-10 left-pull-10">Receipt Status</td>
		...
		<?php
			...
			foreach($wgt_po as $key2 => $val2) {
				...
				$receipt_stat = $val2['receipt_status'];
				$receipt_stat_color = wgtcolor($receipt_stat);

				$numbr += 1;
				if($receipt_stat == 'Pending') { $total_amount = $total_amount + $val2['order_net_amount']; }
				else { $total_amount = $total_amount + $val2['order_net_r_amount']; }
				...
				?>
					<tr>
						...
						<?php else: ?>
						<td class="right-pull-10 left-pull-10"><?php echo number_format($val2['order_total_r_amount'],2); ?></td>
						<td class="right-pull-10 left-pull-10"><?php echo number_format($val2['order_net_r_amount'],2); ?></td>
						<?php endif; ?>
						<td class="right-pull-10 left-pull-10" style="color: <?php echo $order_stat_color; ?>"><?php echo $order_stat; ?></td>
						<td class="right-pull-10 left-pull-10" style="color: <?php echo $receipt_stat_color; ?>"><?php echo $receipt_stat; ?></td>
						<td class="right-pull-10 left-pull-10"><?php echo $_gparams[$var_user]['returnval']; ?></td>
					</tr>
				<?php

				$buyingUnit = ""; $order_stat = ""; $order_stat_color = ""; $receipt_stat = ""; $receipt_stat_color = "";
			}
		?>
		...
		<tr>
			...
			<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
			<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
			<td class="default-text-font-bold right-pull-10 left-pull-10 alignrt">&nbsp;</td>
			<td class="yellow-theme default-text-font-bold right-pull-10 left-pull-10"><?php echo number_format($total_amount,2); ?></td>
			<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
			<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
			<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
		</tr>
