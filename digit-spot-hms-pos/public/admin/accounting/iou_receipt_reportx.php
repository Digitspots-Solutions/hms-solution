			...
			?>
				<div id="tktBox" class="fx-position-stick fscr zind-2 txp8-white noscroll xfadeout motion" align="center">
					...
					<div id="rBox" class="fx-width-40 pads30 white-theme obj-shadow xsml-rounded-button alignlt">
						<form action="" method="post" autocomplete="off">
							<div class="pads10 alignlt">
								<h3 class="large nobold">Indicate amount for iou number <u><?php echo $get_iou_no; ?></u></h3><h3 class="large nobold default-text-font-bold"><?php echo $get_pr_no; ?> (&#8358;<?php echo number_format($pr_amount); ?>)</h3><br>
								<input type="text" name="wgtamount2disburse" id="wgtamount2disburse" placeholder="Enter here" onkeyup="numberinputFormat(this.value,this.id,'amount2disburse')" class="no-back-black default-text-font-bold" required>
