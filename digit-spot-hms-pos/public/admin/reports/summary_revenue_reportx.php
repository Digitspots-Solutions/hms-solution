					...
					if(isset($_POST['reporting']) && $_POST['reporting'] === 'post') {
						...
						?>
								...
								<table cellpadding="3" cellspacing="0" border="1" style="font-size: 10px !important;">
									...
									<?php
										if(is_array($get_posstores)) {
											...
											$posid = ""; $posname = ""; $taxes = ""; $service_charge = "";
											$sql_1 = ""; $sql_2 = ""; $sql_3 = "";
											...
											foreach($get_posstores as $key => $val) {
												...
												/*$sql_1 = "SELECT SUM(tax_amount) AS vat, SUM(consumption_amount) AS consumption, SUM(service_charge_amount) AS scharge, SUM(bill_amount) AS total, SUM(discount_amount) AS discount FROM {$tbL100} WHERE posid={$posid} AND billtype IN(1,2,4,5) AND status IN('Completed') AND isreversed=0 AND deletedata=0 AND datelogged='{$endate}'"; $dataset_1 = wgetSQL($sql_1);

												$sql_2 = "SELECT SUM(bill_amount) AS total FROM {$tbL100} WHERE posid={$posid} AND billtype=3 AND status IN('Completed') AND isreversed=0 AND deletedata=0 AND datelogged='{$endate}'"; $dataset_2 = wgetSQL($sql_2);

												$sql_3 = "SELECT SUM(tax_amount) AS vat, SUM(consumption_amount) AS consumption, SUM(service_charge_amount) AS scharge, SUM(bill_amount) AS total, SUM(discount_amount) AS discount FROM {$tbL100} WHERE posid={$posid} AND billtype IN(1,2,4,5) AND status IN('Completed') AND isreversed=0 AND deletedata=0 AND datelogged BETWEEN '{$startdate}' AND '{$endate}'"; $dataset_3 = wgetSQL($sql_3);

												$tax_1 = $dataset_1[0]['vat'];
												$tax_2 = $dataset_1[0]['consumption'];
												$tax_3 = $dataset_1[0]['scharge'];

												$accumulated_revenue = $dataset_3[0]['total'] - ($dataset_3[0]['vat'] + $dataset_3[0]['consumption'] + $dataset_3[0]['scharge']);
												*/

												$sql_1 = "SELECT SUM(amount) AS total, SUM(discount) AS discount FROM {$tbL99} WHERE posid={$posid} AND billtype IN(1,2,4,5) AND status IN('Completed') AND isreversed=0 AND deletedata=0 AND datelogged='{$endate}'"; $dataset_1 = wgetSQL($sql_1);

												$sql_2 = "SELECT SUM(amount) AS total FROM {$tbL99} WHERE posid={$posid} AND billtype=3 AND status IN('Completed') AND isreversed=0 AND deletedata=0 AND datelogged='{$endate}'"; $dataset_2 = wgetSQL($sql_2);

												$sql_3 = "SELECT SUM(amount) AS total, SUM(discount) AS discount FROM {$tbL99} WHERE posid={$posid} AND billtype IN(1,2,4,5) AND status IN('Completed') AND isreversed=0 AND deletedata=0 AND datelogged BETWEEN '{$startdate}' AND '{$endate}'";
							...
							<?php
								...
								$sql_24 = "SELECT SUM(amount) AS total, COUNT(plan) AS member FROM {$tbL105} t1 LEFT JOIN {$tbL107} t2 ON t1.recreation_number=t2.recreation_number WHERE t1.archivedata=0 AND t1.deletedata=0 AND t1.datelogged BETWEEN '{$endate}' AND '{$endate}'"; $dataset_24 = wgetSQL($sql_24);

								$sql_25 = "SELECT SUM(amount) AS total, COUNT(plan) AS member FROM {$tbL105} t1 LEFT JOIN {$tbL107} t2 ON t1.recreation_number=t2.recreation_number WHERE t1.archivedata=0 AND t1.deletedata=0 AND t1.datelogged BETWEEN '{$startdate}' AND '{$endate}'"; $dataset_25 = wgetSQL($sql_25);
								...
								$sql_26 = "SELECT SUM(amount) AS total, COUNT(plan) AS member FROM {$tbL105} t1 LEFT JOIN {$tbL107} t2 ON t1.recreation_number=t2.recreation_number WHERE t1.archivedata=1 AND t1.deletedata=0 AND t1.datelogged BETWEEN '{$endate}' AND '{$endate}'"; $dataset_26 = wgetSQL($sql_26);

								$sql_27 = "SELECT SUM(amount) AS total, COUNT(plan) AS member FROM {$tbL105} t1 LEFT JOIN {$tbL107} t2 ON t1.recreation_number=t2.recreation_number WHERE t1.archivedata=1 AND t1.deletedata=0 AND t1.datelogged BETWEEN '{$startdate}' AND '{$endate}'"; $dataset_27 = wgetSQL($sql_27);

								$renewal_count = $dataset_26[0]['member'];
								$renewal_amount = $dataset_26[0]['total'];
								$renewal_accuml_count = $dataset_27[0]['member'];
								$renewal_accuml_revenue = $dataset_27[0]['total'];
							...
							<?php
								...
								$sql_10x = "SELECT SUM(amount) AS total FROM {$tbL107} t1 LEFT JOIN {$tbL105} t2 ON t1.recreation_number=t2.recreation_number WHERE t2.archivedata=0 AND t2.deletedata=0 AND t2.datelogged BETWEEN '{$endate}' AND '{$endate}'"; $dataset_10x = wgetSQL($sql_10x);

								$sql_11x = "SELECT SUM(amount) AS total FROM {$tbL107} t1 LEFT JOIN {$tbL105} t2 ON t1.recreation_number=t2.recreation_number WHERE t2.archivedata=0 AND t2.deletedata=0 AND t2.datelogged BETWEEN '{$startdate}' AND '{$endate}'"; $dataset_11x = wgetSQL($sql_11x);

								$sql_12x = "SELECT SUM(amount) AS total FROM {$tbL107} t1 LEFT JOIN {$tbL105} t2 ON t1.recreation_number=t2.recreation_number WHERE t2.archivedata=1 AND t2.deletedata=0 AND t2.datelogged BETWEEN '{$endate}' AND '{$endate}'"; $dataset_12x = wgetSQL($sql_12x);

								$sql_13x = "SELECT SUM(amount) AS total FROM {$tbL107} t1 LEFT JOIN {$tbL105} t2 ON t1.recreation_number=t2.recreation_number WHERE t2.archivedata=1 AND t2.deletedata=0 AND t2.datelogged BETWEEN '{$startdate}' AND '{$endate}'"; $dataset_13x = wgetSQL($sql_13x);
								...
								$renewal_revenue_notax = $renewal_amount;
								$renewal_rebate = 0; 
								$renewal_revenue_norebate = 0;
							...
							<?php
								...
								$roomsCheckedin = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf IN(0,7)"; $gt_roomCheckedin = wgetSQL($roomsCheckedin);

								$sql_30 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='individual' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=2"; $dataset_30 = wgetSQL($sql_30);

								$sql_31 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='individual' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=1"; $dataset_31 = wgetSQL($sql_31);
								...
								$sql_33 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='individual' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf IN(0,7) AND actual_room_amount = room_amount AND discount_amount = 0"; $dataset_33 = wgetSQL($sql_33);

								$sql_34 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='individual' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf IN(0,7) AND (actual_room_amount > room_amount OR discount_amount > 0)"; $dataset_34 = wgetSQL($sql_34);
								...
								$sql_35 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='corporate' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=2"; $dataset_35 = wgetSQL($sql_35);

								$sql_36 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='corporate' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=1"; $dataset_36 = wgetSQL($sql_36);
								...
								$sql_38 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='corporate' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf IN(0,7) AND actual_room_amount = room_amount AND discount_amount = 0"; $dataset_38 = wgetSQL($sql_38);

								$sql_39 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='corporate' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf IN(0,7) AND (actual_room_amount > room_amount OR discount_amount > 0)"; $dataset_39 = wgetSQL($sql_39);
								...
								$sql_40 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='complimentary' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=2"; $dataset_40 = wgetSQL($sql_40);

								$sql_41 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='complimentary' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=1"; $dataset_41 = wgetSQL($sql_41);
								...
								$sql_43 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='complimentary' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf IN(0,7) AND actual_room_amount = room_amount AND discount_amount = 0"; $dataset_43 = wgetSQL($sql_43);

								$sql_44 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='complimentary' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf IN(0,7) AND (actual_room_amount > room_amount OR discount_amount > 0)"; $dataset_44 = wgetSQL($sql_44);
								...
								$sql_45 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='online' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=2"; $dataset_45 = wgetSQL($sql_45);

								$sql_46 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='online' AND deletedata=0 AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf=1"; $dataset_46 = wgetSQL($sql_46);
								...
								$sql_48 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='online' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND wkf NOT IN(1,2) AND actual_room_amount = room_amount AND discount_amount = 0"; $dataset_48 = wgetSQL($sql_48);

								$sql_49 = "SELECT COUNT(roomid) AS total FROM {$tbL134} WHERE charge_type='online' AND bill_date='{$endate}' AND room_status IN('CheckedIn') AND (actual_room_amount > room_amount OR discount_amount > 0)"; $dataset_49 = wgetSQL($sql_49);
