...
$row = "array";
$constrain = array("moduleid"=>5,"status"=>"Active");
...
{
	$isprivilege = perform_role_check($tbL5,$myrole,5,0);
	if(isset($isprivilege) && $isprivilege >= 1) {
		...
		if(is_array($dataCollect))
		{
			...
			<div class="block-element cs-height-120 sky-blue-theme top-pull-15 right-pull-10 left-pull-10">
				<small class="block-element"><b>Business Status</b></small>
				<div class="block-element top-pull-5 bottom-pull-15 bottom-push-5 ft-xsml-size">
					<small class="block-element bottom-push-3">Audit Done till: <b><?php echo $print_last_audit_date; ?></b></small><small class="block-element bottom-push-3">Business Date: <b><?php echo $print_lastlong; ?></b></small>
