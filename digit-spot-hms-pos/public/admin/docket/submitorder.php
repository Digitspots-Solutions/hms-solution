...
<h2 class="large nobold ft-tahoma light-red-font alignlt">Submitting order..</h2>
...
//if(isset($_POST['orderbutton'])) {
	...
	$cashier = $userSignedIn;
	
	$itemid = $_POST['itemid']; $price = $_POST['price']; $qty = $_POST['qty'];
	$subtotal = $_POST['sub-total']; $bill_amount = $_POST['grand-total']; $item_discount = 0;
	$remarks = $_POST['remarks']; $tax_amount = 0; $discount_amount = 0;
	...
	if((isset($is_invoice) && $is_invoice == 2) && (isset($log_order) && $log_order >= 1)) {
		...
		?>
			<h1 class="xlarge ft-tahoma alignlt">Order was submitted successfully</h1>
		<?php
	}
