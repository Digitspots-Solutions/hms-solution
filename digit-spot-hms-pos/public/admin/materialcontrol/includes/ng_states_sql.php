<?php
$chk_state_tbl = mysqli_query($mysqli,"SELECT * FROM states");
if(@ mysqli_num_rows($chk_state_tbl) == false)
{
	mysqli_query($mysqli, "CREATE TABLE IF NOT EXISTS states(id int, name varchar(255), deletedata int default 0)");
	mysqli_query($mysqli, "CREATE TABLE IF NOT EXISTS local_governments(id int AUTO_INCREMENT, state_id int, name varchar(255), PRIMARY KEY (id))");

	mysqli_query($mysqli,"INSERT INTO states(id, name) VALUES
	(1, 'Abia'),
	(2, 'Adamawa'),
	(3, 'Akwa Ibom'),
	(4, 'Anambra'),
	...
	mysqli_query($mysqli,"INSERT INTO local_governments (id, state_id, name) VALUES
	(1, 1, 'Aba North'),
	(2, 1, 'Aba South'),
	(3, 1, 'Arochukwu'),
	(4, 1, 'Bende'),
