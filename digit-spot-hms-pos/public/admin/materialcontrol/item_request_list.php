							...
							<div class="cs-width-1200">
								<table cellspacing="0" cellpadding="0">
									...
									<?php
										...
										foreach($wgt_ir2 as $key2 => $val2) {
											...
											?>
												<tr>
													...
													<td class="right-pull-10 left-pull-10 cs-width-150 pads7"><input type="hidden" name="qtyrequired[]" value="<?php echo $val2['qty_required']; ?>" required><?php if($stock_balance > 0) { ?><input type="number" min="1" name="qtytransfer[]" placeholder="Enter here?" value="<?php if($val2['qty_received'] > 0) { echo $val2['qty_received']; } ?>" required><?php } else { ?><input type="number" min="1" name="qtytransfer[]" placeholder="0" value="<?php if($val2['qty_received'] > 0) { echo $val2['qty_received']; } ?>" class="no-back-black"><?php } ?></td>
										...
										$get_remark = idget_fname($get_requestno,'request_number','remark','ir_remark_tbl');
