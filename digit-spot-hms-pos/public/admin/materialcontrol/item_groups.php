				...
				<div class="pads30">
					...
					<div class="block-element bottom-push-30">
					 	<span class="ln-display-box float-left">
							...
							&nbsp; Note: create item group by clicking <u>new group</u> button
					 	</span>
					 	<span class="ln-display-box float-right">
							<a href="javascript:void(0)" class="blue-font box-border-thick rounded-button top-pull-10 right-pull-20 bottom-pull-10 left-pull-20" onclick="jsForm()">New Group <b class="fa-arrow-right left-push-5"></b></a>
						</span>
						...
						if($istype['isdata'] == true) {
							...
							if(is_array($wgttype) && count($wgttype)) {
								foreach($wgttype as $key => $val) {
									...
									?>
										<span id="tlnk<?php echo $numbr; ?>" class="fx-display-box fx-float-left pads10 right-push-5 bottom-push-10 royal-blue-font anchor" onclick="xfa(<?php echo $numbr; ?>)" lang="off"><h3 class="large nobold nomargin"><?php echo $val['groupname']; ?><b class="fa-arrow-right left-push-10"></b></h3>

											<div id="dr-<?php echo $numbr; ?>" class="noshow xsml-rounded-button xfadein motion-x tLnk" align="left">
												<ul class="nolist">
													<li class="bottom-push-7 dark-black-font" onclick="popto(<?php echo $val['id']; ?>)">Edit</li>
...
<script>
	...
	function jsForm() {
		...
		datastring.tip = "Creating new item group-name";
		datastring.element = "html/item_group.html";
	...
	function popto(id) {
		...
		function wgtpop(response) {
			...
			vhtml += '<h3 class="xlarge nobold nomargin nunito-bold alignlt">'+ajaxresult.datastring[0].groupname+'</h3>';
			vhtml += '</div>';
