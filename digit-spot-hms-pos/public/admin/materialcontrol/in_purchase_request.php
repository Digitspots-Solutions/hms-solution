<?php
	...
	//$keywords = " AND order_number='{$_GET['orderno']}' AND order_status='Pending'";
	if(isset($_GET['orderno'])) { $keywords = " AND order_number='{$_GET['orderno']}'"; $disableHeaders = 1; }
	else { $keywords = " AND order_status IN('Archived')"; $disableHeaders = 0; }
										...
										if($val['gstat'] == 'Pending') {
											...
											if($val['order_status'] == 'Approved') {
														...
														if($val['pr_status'] == 'Job Order') {
															...
															if($val['var_approval'] == 'No') {
																?>
																	...
																	<a href="javascript:void(0)" class="blue-font box-border-thick-green top-pull-7 right-pull-20 bottom-pull-7 left-pull-20 rounded-button white-theme obj-light-shadow right-push-10" onclick="dopr('<?php echo $val['order_number']; ?>')">Receive PR</a>

																	<a href="javascript:void(0)" class="blue-font box-border-thick-green top-pull-7 right-pull-20 bottom-pull-7 left-pull-20 rounded-button white-theme obj-light-shadow right-push-10" onclick="doJoborder('<?php echo $val['order_number']; ?>')">Job Order</a>

																	<a href="javascript:void(0)" class="blue-font box-border-thick-green top-pull-7 right-pull-20 bottom-pull-7 left-pull-20 rounded-button white-theme obj-light-shadow right-push-10" onclick="iou('<?php echo $val['order_number']; ?>')">Create IOU</a>
												...
												?>
													...
													<a href="javascript:void(0)" class="blue-font box-border-thick top-pull-7 right-pull-20 bottom-pull-7 left-pull-20 rounded-button white-theme obj-light-shadow right-push-10" onclick="jsPrint('<?php echo $val['order_number']; ?>')">Print PR <b class="fas fa-print left-push-5"></b></a><br><br><br>
													<a href="javascript:void(0)" class="blue-font box-border-thick top-pull-7 right-pull-20 bottom-pull-7 left-pull-20 rounded-button white-theme obj-light-shadow right-push-10" onclick="jsEdit(); callupPr('<?php echo $val['order_number']; ?>')">Edit <b class="fas fa-edit left-push-5"></b></a> <a href="javascript:void(0)" class="blue-white-state top-pull-7 right-pull-20 bottom-pull-7 left-pull-20 rounded-button right-push-10" onclick="wgtfsubmit('datasheet','delete')">Delete  <b class="fas fa-trash-alt left-push-5"></b></a>
												<?php
											}
										}
									...
									<div class="cs-width-2000">
										<table cellspacing="0" cellpadding="0">
													...
													?>
														<tr>
															...
															<td class="right-pull-10 left-pull-10">
																<?php echo $val2['qty_ordered'].' '.$buyingUnit; ?>
															</td>
															<td class="right-pull-10 left-pull-10">
																<?php echo number_format($val2['unitprice'],2); ?>
															</td>
															<td class="right-pull-10 left-pull-10">
																<?php echo number_format($val2['order_total_amount'],2); ?>
															</td>
															<td class="right-pull-10 left-pull-10">
																<?php echo number_format($val2['order_net_amount'],2); ?>
															</td>
											...
											<tr>
												...
												<td id="gr-total" class="yellow-theme nunito-bold right-pull-10 left-pull-10"><?php echo number_format($total_amount,2); ?></td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
...
<div id="tktBox" class="xfadein noshow motion" align="center">
	<div id="rBox" class="fx-width-90 cs-height-500 white-theme xsml-rounded-button alignlt top-push-30 noscroll"></div>
</div>
