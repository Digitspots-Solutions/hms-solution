		...
		<span class="ln-display-box float-right top-pull-7">
			<?php 
				...
				if(isset($allowRemoveStock) && $allowRemoveStock == 200) {
					?>
						<a href="javascript:void(0)" class="top-pull-10 right-pull-30 bottom-pull-10 left-pull-30 rounded-button blue-white-state" onclick="wgtfsubmit('datasheet','delete')">Remove Stock</a>
					<?php
				}
			?>
		</span>
