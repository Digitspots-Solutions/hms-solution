...
<div class="pads30">
	...
	<div class="x-scroll bottom-pull-10">
		<div class="nc-width-100">
			...
			<h3 class="large nobold nunito-bold alignct">Stock Variation for PR: <?php echo $get_orderno; ?></h3>
			<h3 class="large nobold nunito-regular alignct">Use tab key when you change any value before you apply/save</h3><br>

			<form action="" method="post" autocomplete="off">
				<p class="alignrt">
					<input type="submit" id="submitbutton" name="submitbutton" value="Apply Changes" class="top-pull-7 right-pull-20 bottom-pull-7 left-pull-20 blue-white-state nunito-semibold rounded-button anchor letter-spacing-2 nodefault-appearance">
				</p>

				<input type="hidden" name="uri" value="update-stock-variance">
						...
						foreach($wgt_vpr as $key => $val) {
							...
							?>
								<tr>
									...
									<td class="right-pull-10 left-pull-10"><input type="text" name="qtyrequired[]" id="qtyr<?php echo $numb; ?>" value="<?php echo $val['qty_required']; ?>" placeholder="Quantity Required" class="qtyrd" readonly></td>
									<td class="right-pull-10 left-pull-10"><input type="text" name="qtybought[]" id="qtyb<?php echo $numb; ?>" placeholder="Enter here?" value="<?php echo $val['qty_bought']; ?>" class="qtybt" onblur="wgetQvar(<?php echo $numb; ?>)"></td>
									<td class="top-pull-5 bottom-pull-5 right-pull-10 left-pull-10"><input type="text" name="qtydiff[]" id="qtyd<?php echo $numb; ?>" placeholder="Auto?" value="<?php echo $val['qty_diff']; ?>" class="qtydf" readonly></td>
									...
									<td class="top-pull-5 bottom-pull-5 right-pull-10 left-pull-10"><input type="number" min="1" name="mktprice[]" id="mkt<?php echo $numb; ?>" placeholder="Enter here?" value="<?php echo $val['market_price']; ?>" class="mktprice" onblur="wgetPvar(<?php echo $numb; ?>)"></td>
