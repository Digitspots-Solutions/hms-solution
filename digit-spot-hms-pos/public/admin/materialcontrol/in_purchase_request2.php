<?php
	...
	if(isset($_GET['orderno'])) { $keywords = " AND order_number='{$_GET['orderno']}' AND order_status='Pending'"; $disableHeaders = 1; }
	else { $keywords = " AND order_status IN('Pending','Approved')"; $disableHeaders = 0; }
...
<div class="pads30">
	...
	<form action="" method="post" autocomplete="off" id="datasheet">
		...
		<?php
			...
			if($disableHeaders == 0) {
				?>
					<div class="alignlt"><h3 class="large nobold nomargin"><a href="<?php /echo $ths_page; ?>" title="Refresh" class="right-push-10"><img src="<?php echo DOMAIN_URL; ?>theme/images/general/refresh.png"></a> Click <a href="javascript:void(0)" class="blue-font" onclick="jsForm(); fSp()"><u>here</u></a> to create new purchase order</h3></div>
									...
									<?php
										if($val['gstat'] == 'Pending') {
											...
											if($val['order_status'] == 'Approved') {
												?>
													Order No: <b class="nobold default-text-font-bold royal-blue-font"><?php echo $val['order_number']; ?></b><br>
									...
									<div class="cs-width-2000">
										<table cellspacing="0" cellpadding="0">
												...
												foreach($wgt_supplier as $key2 => $val2) {
													...
													?>
														<tr>
															...
															<td class="right-pull-10 left-pull-10">
																<ul class="nolist">
																	<li class="ln-display-box float-left">
																		<input type="text" name="qtyordered[]" value="<?php echo $val2['qty_ordered']; ?>" class="nopads no-back-black" placeholder="Enter quantity?">
																	</li>
																	<li class="ln-display-box float-left">
																		<?php echo $buyingUnit; ?>
																	</li>
															...
															<td class="right-pull-10 left-pull-10">
																<input type="number" min="1" step=".01" name="unitprice[]" value="<?php echo $val2['unitprice']; ?>" class="nopads no-back-black" placeholder="Enter unit price?">
																<?php //echo number_format($val2['unitprice']); ?>
															</td>
															<td class="right-pull-10 left-pull-10">
																<input type="number" min="1" step=".01" name="ordertotalamount[]" value="<?php echo $val2['order_total_amount']; ?>" class="nopads no-back-black" placeholder="Enter total amount?" readonly="readonly">
																<?php //echo number_format($val2['order_total_amount']); ?>
															</td>
															<td class="right-pull-10 left-pull-10">
																<input type="number" min="1" step=".01" name="ordernetamount[]" value="<?php echo $val2['order_net_amount']; ?>" class="nopads no-back-black" placeholder="Enter net amount?" readonly="readonly">
																<?php //echo number_format($val2['order_net_amount']); ?>
															</td>
											...
											<tr>
												...
												<td id="gr-total" class="yellow-theme nunito-bold right-pull-10 left-pull-10"><?php echo number_format($total_amount); ?></td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
												<td class="default-text-font-bold right-pull-10 left-pull-10">&nbsp;</td>
