...
$row = "array";
$constrain = array("moduleid"=>1,"status"=>"Active");
$dataCollect = mysqli_data_fetch($tbL10,'id,category',$constrain,$row);

$admin_pos_menu = array('Hotel Details','Hotel Logo','Company Details','Company Logo','Shifts','Pay Types','Denominations','Roles And Privileges','Users','Pos Stores','Pos Sequence','Pos Invoice Sequence','For Accounting','For Iou','For Pr','For Transfer Request','For Stock Variation','For Item Request','For Item Receiving');
			...
			if($cvalue['category'] != 'Non-module') {
				...
				if(isset($submdls) && $submdls >= 1) {
					...
					<div id="mdl1<?php echo $cvalue['id']; ?>" class="block-element">
						...
						<?php if($cvalue['category'] == 'Rooms Manager' && $_SESSION['app_service'] == 'hotel-management'): ?>
						...
						<span class="ln-display-box float-left nc-width-90">
							<small class=""><?php echo $cvalue['category'].$_SESSION['app_service']; ?></small>
						</span>
						...
						<?php endif; ?>
						<?php if($cvalue['category'] == 'Profiles' && $_SESSION['app_service'] == 'hotel-management'): ?>
						<div id="cmdl1<?php echo $cvalue['id']; ?>" lang="uncollapsed" class="block-element top-pull-10 right-pull-10 bottom-pull-10 left-pull-10 sky-dark-deep-blue-theme dark-black-font anchor box-border-thick-bottom" onclick="forsubmenu('cmdl1<?php echo $cvalue['id']; ?>','lmdl1<?php echo $cvalue['id']; ?>','xlmdl1<?php echo $cvalue['id']; ?>')">
						<span class="ln-display-box float-left nc-width-90">
							<small class=""><?php echo $cvalue['category'].$_SESSION['app_service']; ?></small>
						</span>
						...
						<?php endif; ?>
						<?php if($cvalue['category'] == 'Booking Sequence Settings' && $_SESSION['app_service'] == 'hotel-management'): ?>
						<div id="cmdl1<?php echo $cvalue['id']; ?>" lang="uncollapsed" class="block-element top-pull-10 right-pull-10 bottom-pull-10 left-pull-10 sky-dark-deep-blue-theme dark-black-font anchor box-border-thick-bottom" onclick="forsubmenu('cmdl1<?php echo $cvalue['id']; ?>','lmdl1<?php echo $cvalue['id']; ?>','xlmdl1<?php echo $cvalue['id']; ?>')">
						<span class="ln-display-box float-left nc-width-90">
							<small class=""><?php echo $cvalue['category'].$_SESSION['app_service']; ?></small>
						</span>
						...
						<?php endif; ?>
						<?php if($cvalue['category'] != 'Rooms Manager' && $cvalue['category'] != 'Profiles' && $cvalue['category'] != 'Booking Sequence Settings'): ?>
						<div id="cmdl1<?php echo $cvalue['id']; ?>" lang="uncollapsed" class="block-element top-pull-10 right-pull-10 bottom-pull-10 left-pull-10 sky-dark-deep-blue-theme dark-black-font anchor box-border-thick-bottom" onclick="forsubmenu('cmdl1<?php echo $cvalue['id']; ?>','lmdl1<?php echo $cvalue['id']; ?>','xlmdl1<?php echo $cvalue['id']; ?>')">
						<span class="ln-display-box float-left nc-width-90">
							...
							<div id="xlmdl1<?php echo $cvalue['id']; ?>" class="noshow motion">
								<?php
									foreach ($submdl_data as $subkey => $subvalue) {
										if(in_array($subvalue['name'], $admin_pos_menu)) {
											?>
...
{
	$isprivilege = perform_role_check($tbL5,$myrole,1,0);
