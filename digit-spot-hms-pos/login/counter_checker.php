<?php include "../includes/php_paths.php"; include BWF_PATH.ROOT_FLD._DB_SERVER_; include BWF_PATH.ROOT_FLD._DB_TABLES_; include BWF_PATH.ROOT_FLD._FUNC_; include BWF_PATH.ROOT_FLD._SERVER_CUR_DATE_; include BWF_PATH.ROOT_FLD._USRP_;
...
if(isset($_GET['counter']) && $_GET['counter'] == 'ncls')
{
	...
	$htmlresult .='&nbsp;&nbsp;';
	$htmlresult .='<a href="'.DOMAIN_URL.'public/admin/portal'.PHP_EXT.'" class="submit pads10 black-white-state rounded-button nc-width-50"> &nbsp; Continue Working &nbsp; </a>';
	$htmlresult .='<br><br>';
}
elseif(isset($_GET['counter']) && $_GET['counter'] == 'forced-cls')
{
	...
	$htmlresult .='&nbsp;&nbsp;';
	$htmlresult .='<a href="'.DOMAIN_URL.'public/admin/portal'.PHP_EXT.'" class="submit pads10 black-white-state rounded-button nc-width-50"> &nbsp; Continue &nbsp; </a>';
	$htmlresult .='<br><br>';
}
