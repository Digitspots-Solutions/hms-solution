...
isdocket varchar(10) default 'No',
...
##table: Chart of accounts table
$var_coa_tbl_1 = "CREATE TABLE IF NOT EXISTS coa_setup_tbl(
id bigint(50) auto_increment,
account_type varchar(50),
account_name varchar(50),
ppr varchar(50) default 0,
plf int default 0,
plf_date date default '0000-00-00',
mdpr varchar(50) default 0,
status varchar(50) default 'Active',
datelogged date,
timelogged time,
deletedata int default 0,
...
##table: Journal entry table
$var_coa_tbl_2 = "CREATE TABLE IF NOT EXISTS coa_entry_tbl(
id bigint(50) auto_increment,
coa_id int,
amount varchar(50),
